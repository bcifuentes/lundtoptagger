...
def main():
    ...
    for path_to_test_file in path_MCs:
        ...
        for file in files:
            ...
            jet_phis  = jet_phis[:N]
            jet_ms    = jet_ms[:N]
            ptweights = ptweights[:N]
            labels    = labels[:N]
            
            print("\n=== DEBUG: sizes before writing ROOT file ===")
            print("dsids:",               len(dsids))
            print("mcweights_out:",       len(mcweights_out))
            print("tagger_scores:",       len(tagger_scores))
            print("jet_pts:",             len(jet_pts))
            print("jet_etas:",            len(jet_etas))
            print("jet_phis:",            len(jet_phis))
            print("jet_ms:",              len(jet_ms))
            print("ptweights:",           len(ptweights))
            print("labels:",              len(labels))
            print("Good_jets:",           len(Good_jets))
            print("===========================================\n")
